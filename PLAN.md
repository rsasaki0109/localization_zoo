...
| 実装済み from-paper 論文数 | **34 本** (§00.48–§00.50) |
| `docs/methods.json` | **74 手法** (campaign 開始前 ~40 → 74) |
| main HEAD | `06d6751` (paper 34 InTEn-LOAM) → 次 commit で I-LOAM mapping |
| 直近完了 | **I-LOAM mapping 統合** — aloam LaserMapping を追加 (デフォルト ON)。seq00 **0.899%** / seq07 **0.575%** drift (A-LOAM 同列)。README leaderboard 行追加 |
...
### 00.6 次の一手 (34本目完了後) + 新規サーベイ shortlist (2026-06-08)
