...
| Item | Value |
|------|-------|
| Branch | `feat/unossed-papers-30` |
| 実装済み from-paper 論文数 | **30 本** (下記 §00.4) |
| `docs/methods.json` | **70 手法** (campaign 開始前 ~40 → 70) |
| 最新コミット | TrICP-LO (30本目) commit 済み |
| 直近完了 | **TrICP-LO (30本目)** — seq00 0.931% / ATE 10.0 m / seq07 0.662%、competitive (seq00 ATE は KISS-ICP 12.0 m を上回る) |
...
- distinct な古典機構は **ほぼ枯渇**。saturated: ground/degeneracy/voxelmap/feature-weighting/
  ...
  gmm-em/correntropy/implicit-surface(IMLS)。direct/range-image は発散。公開コード有で除外:
