...
| main HEAD | `a8c3a75` (paper 33 PL-LOAM) → 次 commit で paper 34 |
| 直近完了 | **InTEn-LOAM (34本目)** — 円筒 range+intensity + B-spline 強度登録 (DOR/mapping 省略)。seq00 **52.7%** / seq07 **67.5%** drift (**honest negative**; 強度 ablation seq07 は near-neutral 66.9%) |
| 直前完了 | **PL-LOAM (33本目)** — LiDAR 投影疑似画像上の点線 VO。seq00 **143%** / seq07 **117%** drift (RGB 無し honest negative) |
...
**OdoNet** (IMU 学習、着手前に方式合意) → I-LOAM mapping 追加 → PL-LOAM KITTI Raw RGB 本評価。
