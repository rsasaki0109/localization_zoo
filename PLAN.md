...
- **次**: M-GCLO public non-flat dataset validation、Quadric-LO curved-object / non-urban dataset check、
...
- **次**: Quadric-LO curved-object / non-urban dataset check、RF-LIO/ID-LIO public high-dynamic dataset validation、
...
1. **Next action**: add the next missing public/cross-domain check:
   M-GCLO public non-flat dataset validation, Quadric-LO curved-object / non-urban dataset check,
   ...
   artifacts are already committed in §00.52j〜§00.52p.
