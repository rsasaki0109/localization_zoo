...
the [**interactive explorer**](https://rsasaki0109.github.io/localization_zoo/).
...
| CT-ICP | 2.06% <sub>(17 m)</sub> | 2.64% <sub>(67 m)</sub> | 1.12% <sub>(10 m)</sub> | 1.26% <sub>(2 m)</sub> | 1.95% <sub>(40 m)</sub> |
