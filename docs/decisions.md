...
| Variant | Decision | Why |
|---------|----------|-----|
| kitti_default | Rejected for this run | The variant did not produce a valid benchmark result. |
| fast | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| dense | Rejected for this run | The variant did not produce a valid benchmark result. |
...
- Current default: `cluster_d_ms_chol`.
- Active challengers: `balanced_reference`, `cluster_a`.
...
| cluster_a | Keep as active challenger | Close enough to the current default to keep as a live alternative. |
| cluster_d_ms_chol | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
...
- Current default: `fast_reference`.
...
| Variant | Decision | Why |
|---------|----------|-----|
| fast_reference | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| cluster_a | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
- Current default: `fast_window_reference`.
- Reference variants: `cluster_a`, `cluster_d_ms_chol`.
- Aggregate result: `experiments/results/ct_icp_kitti_raw_0061_full_recipes_matrix.json`

| Variant | Decision | Why |
|---------|----------|-----|
| fast_window_reference | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| cluster_a | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
| cluster_d_ms_chol | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
- Active challengers: `cluster_d_full_seeded`.
- Reference variants: `cluster_a_no_seed`, `cluster_a_seeded`.
- Aggregate result: `experiments/results/ct_icp_kitti_seq_07_full_seeded_matrix.json`

| Variant | Decision | Why |
|---------|----------|-----|
| cluster_d_full_no_seed_reference | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| cluster_d_full_seeded | Keep as active challenger | Close enough to the current default to keep as a live alternative. |
...
- Reference variants: `cluster_a_seeded`, `cluster_d_seeded`.
...
- Current default: `dense_reference`.
- Active challengers: `cluster_a`, `cluster_d_ms_chol`.
...
- Active challengers: `cluster_d_with_seed`.
- Reference variants: `dense_reference`, `cluster_a_no_seed`.
- Aggregate result: `experiments/results/ct_icp_mulran_parkinglot_120_recipes_matrix.json`

| Variant | Decision | Why |
|---------|----------|-----|
| dense_reference | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
| cluster_a_no_seed | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
| cluster_a_with_seed | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| cluster_d_with_seed | Keep as active challenger | Close enough to the current default to keep as a live alternative. |
...
- Current default: `fast_recent_map`.
- Active challengers: `dense_recent_map`.
...
| accel_bias_kitti_0009_full | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
| accel_bias_kitti_0009 | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
| accel_bias_full | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
| accel_bias | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
- Current default: `fast_cov_half_threads`.
- Active challengers: `fast_icp_only_half_threads`, `paper_cov_half_threads`, `paper_icp_only_half_threads`.
...
- Current default: `tuned_voxel2_iter12_seeded`.
- Active challengers: `tuned_voxel0_5_iter12_seeded`.
- Reference variants: `tuned_voxel1_iter12_seeded`, `tuned_voxel1_iter20_seeded`.
- Aggregate result: `experiments/results/litamin2_kitti_seq_00_full_tuned_seeded_matrix.json`

| Variant | Decision | Why |
|---------|----------|-----|
| tuned_voxel1_iter12_seeded | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
| tuned_voxel0_5_iter12_seeded | Keep as active challenger | Close enough to the current default to keep as a live alternative. |
...
- Reference variants: `tuned_voxel1_iter12`, `radius1_no_distance_gate`, `radius1_distance_gate_1_5m`, `covariance_gradient`, `covariance_gradient_w0_1_linesearch`, `coarse_to_fine_3_2_1`.
...
| coarse_to_fine_3_2_1 | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
- Reference variants: `radius1_no_distance_gate`, `radius1_distance_gate_1_5m`, `covariance_gradient`, `covariance_gradient_w0_1_linesearch`, `coarse_to_fine_3_2_1`.
...
- Reference variants: `tuned_voxel1_iter12`, `radius1_no_distance_gate`, `radius1_distance_gate_1_5m`, `covariance_gradient_w0_1_linesearch`, `coarse_to_fine_3_2_1`.
...
- Current default: `balanced_local_map`.
- Active challengers: `dense_recent_map`.
- Reference variants: `fast_recent_map`.
...
- Current default: `fast_seeded_reference`.
- Reference variants: `fast_no_seed`, `balanced_no_seed`, `dense_no_seed`.
- Aggregate result: `experiments/results/small_gicp_kitti_seq_00_full_no_seed_matrix.json`

| Variant | Decision | Why |
|---------|----------|-----|
| fast_seeded_reference | Adopt as current default | Best combined benchmark score on the shared dataset and interface. |
| fast_no_seed | Keep as reference variant | Useful for comparison, but not strong enough to replace the current default. |
...
- Current default: `fast_recent_map`.
- Active challengers: `balanced_local_map`.
- Reference variants: `dense_recent_map`.
...
- Current default: `dense_profile`.
- Reference variants: `balanced_reference`, `fast_profile`, `t1_transfer_v05_i12`, `t1_transfer_v03_i12`.
...
- Current default: `default`.
- Reference variants: `fast`, `dense`, `no_gt_seed`.
