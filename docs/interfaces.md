...
Current active selectors: `litamin2`
...
|---------|--------|----------|----------|-----------------|-----------|
| LiTAMIN2 pure-odometry (no GT seed) on MulRan ParkingLot (full sequence) | `ready` | `experiments/pending/litamin2_mulran_parkinglot_full_no_gt_seed_matrix.json` | `litamin2` | `paper_icp_only_no_gt_seed` | `experiments/results/litamin2_mulran_parkinglot_full_no_gt_seed_matrix.json` |
