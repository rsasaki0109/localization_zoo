...
Current active selectors: `ct_icp`, `litamin2`
...
|---------|--------|----------|----------|-----------------|-----------|
| LiTAMIN2 paper-comparable on KITTI Odometry 07 (full, 1101 frames) | `ready` | `experiments/pending/litamin2_kitti_seq_07_full_paper_comp_matrix.json` | `litamin2` | `paper_cov_gt_seed` | `experiments/results/litamin2_kitti_seq_07_full_paper_comp_matrix.json` |
| CT-ICP paper-comparable on KITTI Odometry 07 (full, 1101 frames) | `ready` | `experiments/pending/ct_icp_kitti_seq_07_full_paper_comp_matrix.json` | `ct_icp` | `gt_seeded` | `experiments/results/ct_icp_kitti_seq_07_full_paper_comp_matrix.json` |
