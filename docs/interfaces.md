...
|---------|--------|----------|----------|-----------------|-----------|
| LiTAMIN2 gap-closing on KITTI Odometry 07 (full) | `ready` | `experiments/pending/litamin2_kitti_seq_07_full_gap_close_matrix.json` | `litamin2` | `voxel15_iter10` | `experiments/results/litamin2_kitti_seq_07_full_gap_close_matrix.json` |
| CT-ICP gap-closing on KITTI Odometry 07 (full) | `ready` | `experiments/pending/ct_icp_kitti_seq_07_full_gap_close_matrix.json` | `ct_icp` | `dense_plus_budget` | `experiments/results/ct_icp_kitti_seq_07_full_gap_close_matrix.json` |
