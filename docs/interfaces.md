...
| LiTAMIN2 trade-off on KITTI Raw drive 0009 (200 frames, no GT seed) | `ready` | `experiments/litamin2_kitti_raw_0009_nogt_matrix.json` | `litamin2` | `paper_icp_only_half_threads` | `experiments/results/litamin2_kitti_raw_0009_nogt_matrix.json` |
...
| NDT trade-off on KITTI Raw drive 0009 full sequence (443 frames, urban) | `ready` | `experiments/ndt_kitti_raw_0009_full_matrix.json` | `ndt` | `balanced_local_map` | `experiments/results/ndt_kitti_raw_0009_full_matrix.json` |
