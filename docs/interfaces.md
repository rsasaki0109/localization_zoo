...
|---------|--------|----------|----------|-----------------|-----------|
| CT-ICP architecture-level tuning on KITTI Odometry 07 (full) | `ready` | `experiments/pending/ct_icp_kitti_seq_07_full_arch_close_matrix.json` | `ct_icp` | `prior_best` | `experiments/results/ct_icp_kitti_seq_07_full_arch_close_matrix.json` |
