...
| ct_icp | `hdl_400_open_ct_lio_120` | reference-based | `fast_window` | 2.582 | 54.9 | `experiments/results/ct_icp_hdl_400_reference_matrix.json` |
...
| ct_icp | `hdl_400_ros1_open_ct_lio_120_time_index` | reference-based | `dense_window` | 1.254 | 18.7 | `experiments/results/ct_icp_hdl_400_public_ros1_synthtime_matrix.json` |
| ct_icp | `kitti_raw_0009_200` | reference-based | `balanced_reference` | 1.659 | 40.9 | `experiments/results/ct_icp_kitti_raw_0009_200_recipes_matrix.json` |
...
| ct_icp | `kitti_raw_0061_200` | reference-based | `fast_reference` | 1.475 | 59.4 | `experiments/results/ct_icp_kitti_raw_0061_200_recipes_matrix.json` |
...
| ct_icp | `kitti_seq_00_full` | reference-based | `cluster_a_seeded` | 4.906 | 15.2 | `experiments/results/ct_icp_kitti_seq_00_full_seeded_matrix.json` |
...
| ct_icp | `kitti_seq_07_full` | reference-based | `cluster_d_full_no_seed_reference` | 1.607 | 21.5 | `experiments/results/ct_icp_kitti_seq_07_full_seeded_matrix.json` |
...
| ct_icp | `kitti_seq_08_full` | reference-based | `cluster_a_seeded` | 6.024 | 16.8 | `experiments/results/ct_icp_kitti_seq_08_full_seeded_matrix.json` |
...
| ct_icp | `mcd_kth_day_06_108` | reference-based | `dense_seeded_reference` | 2.778 | 28.3 | `experiments/results/ct_icp_mcd_kth_day_06_seeded_matrix.json` |
...
| ct_icp | `mcd_ntu_day_02_108` | reference-based | `dense_seeded_reference` | 0.451 | 28.4 | `experiments/results/ct_icp_mcd_ntu_day_02_seeded_matrix.json` |
...
| ct_icp | `mcd_tuhh_night_09_108` | reference-based | `dense_seeded_reference` | 1.182 | 27.4 | `experiments/results/ct_icp_mcd_tuhh_night_09_seeded_matrix.json` |
...
| ct_icp | `mulran_parkinglot_120` | reference-based | `cluster_a_with_seed` | 2.547 | 17.9 | `experiments/results/ct_icp_mulran_parkinglot_120_recipes_matrix.json` |
...
| fast_livo2 | `kitti_raw_0009_200` | reference-based | `fast` | 31.368 | 8.3 | `experiments/results/fast_livo2_kitti_raw_0009_matrix.json` |
| fast_livo2 | `kitti_raw_0009_full` | reference-based | `fast` | 49.629 | 7.5 | `experiments/results/fast_livo2_kitti_raw_0009_full_matrix.json` |
| fast_livo2 | `kitti_raw_0061_200` | reference-based | `fast` | 27.581 | 7.2 | `experiments/results/fast_livo2_kitti_raw_0061_matrix.json` |
| fast_livo2 | `kitti_raw_0061_full` | reference-based | `fast` | 96.345 | 14.0 | `experiments/results/fast_livo2_kitti_raw_0061_full_matrix.json` |
...
| gicp | `mulran_parkinglot_120` | reference-based | `fast_recent_map` | 0.644 | 27.7 | `experiments/results/gicp_mulran_parkinglot_120_matrix.json` |
| gicp | `mulran_parkinglot_full` | reference-based | `fast_recent_map` | 1.149 | 30.3 | `experiments/results/gicp_mulran_parkinglot_full_matrix.json` |
...
| kiss_icp | `mulran_parkinglot_120` | reference-based | `fast_recent_map` | 15.641 | 27.3 | `experiments/results/kiss_icp_mulran_parkinglot_120_matrix.json` |
| kiss_icp | `mulran_parkinglot_full` | reference-based | `fast_recent_map` | 74.337 | 26.9 | `experiments/results/kiss_icp_mulran_parkinglot_full_matrix.json` |
...
| litamin2 | `hdl_400_open_ct_lio_120` | reference-based | `fast_cov_half_threads` | 0.111 | 80.7 | `experiments/results/litamin2_hdl_400_reference_matrix.json` |
...
| litamin2 | `kitti_raw_0009_200` | reference-based | `cluster_t1_seeded` | 0.633 | 45.0 | `experiments/results/litamin2_kitti_raw_0009_200_cluster_t1_matrix.json` |
| litamin2 | `kitti_raw_0009_200` | reference-based | `fast_cov_half_threads` | 1.053 | 34.2 | `experiments/results/litamin2_kitti_raw_0009_matrix.json` |
...
| litamin2 | `kitti_raw_0009_full` | reference-based | `cluster_t1_seeded` | 0.666 | 40.2 | `experiments/results/litamin2_kitti_raw_0009_full_cluster_t1_matrix.json` |
...
| litamin2 | `kitti_raw_0061_200` | reference-based | `cluster_t1_seeded` | 0.517 | 48.1 | `experiments/results/litamin2_kitti_raw_0061_200_cluster_t1_matrix.json` |
...
| litamin2 | `kitti_raw_0061_full` | reference-based | `cluster_t1_seeded` | 0.600 | 39.8 | `experiments/results/litamin2_kitti_raw_0061_full_cluster_t1_matrix.json` |
...
| litamin2 | `kitti_seq_00_full` | reference-based | `fast_icp_only_half_threads` | 0.998 | 108.9 | `experiments/results/litamin2_kitti_seq_00_full_matrix.json` |
| litamin2 | `kitti_seq_00_full` | reference-based | `fast_cov_no_gt_seed` | 110.484 | 98.9 | `experiments/results/litamin2_kitti_seq_00_full_paper_comp_matrix.json` |
| litamin2 | `kitti_seq_00_full` | reference-based | `tuned_voxel1_iter12` | 13.464 | 60.9 | `experiments/results/litamin2_kitti_seq_00_full_tuned_matrix.json` |
| litamin2 | `kitti_seq_00_full` | reference-based | `tuned_voxel2_iter12_seeded` | 1.117 | 86.8 | `experiments/results/litamin2_kitti_seq_00_full_tuned_seeded_matrix.json` |
| litamin2 | `kitti_seq_02_full` | reference-based | `cluster_t1_seeded` | 0.728 | 68.3 | `experiments/results/litamin2_kitti_seq_02_full_tuned_seeded_matrix.json` |
| litamin2 | `kitti_seq_05_full` | reference-based | `fast_seeded_reference` | 0.957 | 17.2 | `experiments/results/litamin2_kitti_seq_05_full_tuned_seeded_matrix.json` |
| litamin2 | `kitti_seq_07_full` | reference-based | `fast_seeded_reference` | 0.836 | 94.7 | `experiments/results/litamin2_kitti_seq_07_full_tuned_seeded_matrix.json` |
| litamin2 | `kitti_seq_08_full` | reference-based | `fast_seeded_reference` | 1.130 | 104.9 | `experiments/results/litamin2_kitti_seq_08_full_tuned_seeded_matrix.json` |
| litamin2 | `mcd_kth_day_06_108` | reference-based | `cluster_t1_seeded` | 0.192 | 20.1 | `experiments/results/litamin2_mcd_kth_day_06_cluster_t1_matrix.json` |
| litamin2 | `mcd_kth_day_06_108` | reference-based | `fast_icp_only_half_threads` | 0.401 | 91.6 | `experiments/results/litamin2_mcd_kth_day_06_matrix.json` |
| litamin2 | `mcd_ntu_day_02_108` | reference-based | `cluster_t1_seeded` | 0.021 | 43.4 | `experiments/results/litamin2_mcd_ntu_day_02_cluster_t1_matrix.json` |
| litamin2 | `mcd_ntu_day_02_108` | reference-based | `paper_icp_only_half_threads` | 0.045 | 81.2 | `experiments/results/litamin2_mcd_ntu_day_02_matrix.json` |
| litamin2 | `mcd_tuhh_night_09_108` | reference-based | `cluster_t1_seeded` | 0.132 | 39.5 | `experiments/results/litamin2_mcd_tuhh_night_09_cluster_t1_matrix.json` |
| litamin2 | `mcd_tuhh_night_09_108` | reference-based | `fast_icp_only_half_threads` | 0.194 | 107.2 | `experiments/results/litamin2_mcd_tuhh_night_09_matrix.json` |
| litamin2 | `mulran_parkinglot_120` | reference-based | `cluster_t1_seeded` | 0.212 | 30.6 | `experiments/results/litamin2_mulran_parkinglot_120_cluster_t1_matrix.json` |
| litamin2 | `mulran_parkinglot_120` | reference-based | `fast_cov_half_threads` | 0.498 | 90.2 | `experiments/results/litamin2_mulran_parkinglot_120_matrix.json` |
| litamin2 | `mulran_parkinglot_full` | reference-based | `cluster_t1_seeded` | 0.303 | 34.4 | `experiments/results/litamin2_mulran_parkinglot_full_cluster_t1_matrix.json` |
| litamin2 | `mulran_parkinglot_full` | reference-based | `fast_icp_only_half_threads` | 0.711 | 118.6 | `experiments/results/litamin2_mulran_parkinglot_full_matrix.json` |
...
| okvis | `kitti_raw_0009_200` | reference-based | `fast` | 31.400 | 524.0 | `experiments/results/okvis_kitti_raw_0009_matrix.json` |
| okvis | `kitti_raw_0009_full` | reference-based | `fast` | 108.629 | 1146.6 | `experiments/results/okvis_kitti_raw_0009_full_matrix.json` |
| okvis | `kitti_raw_0061_200` | reference-based | `fast` | 29.001 | 894.7 | `experiments/results/okvis_kitti_raw_0061_matrix.json` |
| okvis | `kitti_raw_0061_full` | reference-based | `fast` | 225.666 | 1717.1 | `experiments/results/okvis_kitti_raw_0061_full_matrix.json` |
...
| vins_fusion | `kitti_raw_0009_200` | reference-based | `fast` | 85.802 | 83.5 | `experiments/results/vins_fusion_kitti_raw_0009_matrix.json` |
| vins_fusion | `kitti_raw_0009_full` | reference-based | `fast` | 136.572 | 93.7 | `experiments/results/vins_fusion_kitti_raw_0009_full_matrix.json` |
| vins_fusion | `kitti_raw_0061_200` | reference-based | `fast` | 61.904 | 255.5 | `experiments/results/vins_fusion_kitti_raw_0061_matrix.json` |
| vins_fusion | `kitti_raw_0061_full` | reference-based | `fast` | 257.641 | 236.7 | `experiments/results/vins_fusion_kitti_raw_0061_full_matrix.json` |
