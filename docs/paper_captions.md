...
The table summarizes 268 ready defaults across 15 GT-backed and 253 reference-based problem instances.
...
The core set currently contains 30 method families and keeps `reference-based` outputs visually distinct from `gt-backed` outputs.
