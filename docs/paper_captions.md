...
The table summarizes 165 ready defaults across 15 GT-backed and 150 reference-based problem instances.
...
The core set currently contains 26 method families and keeps `reference-based` outputs visually distinct from `gt-backed` outputs.
