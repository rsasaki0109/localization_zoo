...
| LiDAR-IBA | T1 evidence candidate | Stereographic plane front-end is competitive on KITTI; the committed no-BA profile favors local RPE over sliding-window BA on this IMU-free protocol. | Commit paired BA on/off ablation JSON before T0 promotion. |
