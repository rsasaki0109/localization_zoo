...
summaries as supporting, non-paper-grade evidence. TrICP-LO now includes a committed
auto vs fixed-overlap ablation; LiDAR-IBA BA on/off ablation is tracked on a separate
branch/PR. RF-LIO/ID-LIO public high-dynamic validation, M-GCLO public non-flat
validation, and Quadric-LO public curved-object/non-urban validation remain open
