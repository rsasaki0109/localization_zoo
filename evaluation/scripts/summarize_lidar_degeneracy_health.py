...
DEFAULT_INPUTS = (
    (
        ...
        (
            ...
            ("litamin2", "experiments/results/lidar_degeneracy/fog_200/litamin2_health/odometry_health_summary.json"),
    ...
    (
        ...
        (
            ...
            ("litamin2", "experiments/results/lidar_degeneracy/tunnel_geom_2700_200/litamin2_health/odometry_health_summary.json"),
