...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `fog_200` | `point_count_tail` 115-144 | `geometry_icp` | 1.234 | 0.431 | 6.259 | 1 | 0.983 | 1.256 | 1.975 | 0.625 | no | none |
| `fog_200` | `point_count_tail` 115-144 | `kiss_keyframe` | 0.732 | 0.382 | 1.892 | 1 | 0.983 | 0.744 | 1.975 | 0.371 | no | none |
| `fog_200` | `degraded` 170-199 | `geometry_icp` | 1.407 | 0.681 | 2.851 | 2 | 1.407 | 1.000 | 2.065 | 0.681 | no | none |
| `fog_200` | `degraded` 170-199 | `intensity_bev` | 8.281 | 6.127 | 46.500 | 2 | 1.407 | 5.884 | 2.065 | 4.009 | yes | path_disagrees_with_healthy_median, path_disagrees_with_all_method_median |
| `fog_200` | `degraded` 170-199 | `kiss_keyframe` | 0.617 | 0.280 | 0.668 | 2 | 1.407 | 0.438 | 2.065 | 0.299 | yes | path_disagrees_with_healthy_median, path_disagrees_with_all_method_median |
...
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `intensity_bev` | 1.000 | 1.000 | 0.801 | 5542.0 | 8.281 | 0.559 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | n/a | ok | cross_method_suspicious | cross_method_suspicious, path_disagrees_with_all_method_median, path_disagrees_with_healthy_median |
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `kiss_keyframe` | 1.000 | 1.000 | 0.797 | 163.3 | 0.620 | 0.050 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | 0/2 | ok | cross_method_suspicious | cross_method_suspicious, path_disagrees_with_all_method_median, path_disagrees_with_healthy_median |
