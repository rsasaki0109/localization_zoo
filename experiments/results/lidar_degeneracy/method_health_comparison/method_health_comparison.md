...
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | 30 | 0.521 | `intensity_bev` | 0.931 | 0.931 | 0.743 | 5159.7 | 11.516 | 1.521 | `ok` | `stress_unflagged` | n/a | ok |
...
| `tunnel_geom_2700_200` | `degraded` 170-199 | `degradation_stress` | 30 | 0.227 | `intensity_bev` | 1.000 | 1.000 | 0.648 | 5534.3 | 7.561 | 0.354 | `ok` | `stress_unflagged` | n/a | ok |
