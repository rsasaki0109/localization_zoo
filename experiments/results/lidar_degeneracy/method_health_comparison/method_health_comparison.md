...
| `fog_200` | `intensity_bev` | 3 | 0.977 | 0.931 | 0.977 | 0 | 1 | 0 | 1 | 1 | 1 | 1 | 0 | 11.516 |
| `fog_200` | `kiss_keyframe` | 3 | 1.000 | 1.000 | 1.000 | 0 | 0 | 1 | 1 | 1 | 1 | 1 | 0 | 0.743 |
...
| `fog_200` | `intensity_bev` | 2 | 1 | 0 | 1 | 0 |
| `fog_200` | `kiss_keyframe` | 2 | 0 | 1 | 1 | 0 |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `fog_200` | `point_count_tail` 115-144 | `kiss_keyframe` | 0.732 | 0.382 | 1.892 | 0 | 0.732 | 1.000 | 1.723 | 0.425 | no | no_healthy_peer |
| `fog_200` | `degraded` 170-199 | `intensity_bev` | 8.281 | 6.127 | 46.500 | 1 | 4.449 | 1.861 | 1.670 | 4.958 | no | path_disagrees_with_all_method_median |
| `fog_200` | `degraded` 170-199 | `kiss_keyframe` | 0.617 | 0.280 | 0.668 | 1 | 4.449 | 0.139 | 1.670 | 0.369 | yes | path_disagrees_with_healthy_median |
...
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | 30 | 0.521 | `kiss_keyframe` | 1.000 | 1.000 | 0.802 | 239.4 | 0.743 | 0.083 | `ok` | `ok` | `watch` | `stress_unflagged` | `stress_unflagged` | 0/2 | ok | ok | no_healthy_peer |
...
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `intensity_bev` | 1.000 | 1.000 | 0.801 | 5542.0 | 8.281 | 0.559 | `ok` | `ok` | `watch` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | path_disagrees_with_all_method_median |
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `kiss_keyframe` | 1.000 | 1.000 | 0.797 | 163.3 | 0.620 | 0.050 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | 0/2 | ok | cross_method_suspicious | cross_method_suspicious, path_disagrees_with_healthy_median |
