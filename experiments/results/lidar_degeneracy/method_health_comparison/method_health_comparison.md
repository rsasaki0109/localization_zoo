...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `fog_200` | `geometry_icp` | 3 | 0.264 | 0.000 | 0.264 | 2 | 2 | 0 | 2 | 0 | 1 | 0 | 2 | 1.276 |
| `fog_200` | `intensity_bev` | 3 | 0.977 | 0.931 | 0.977 | 0 | 1 | 1 | 2 | 1 | 0 | 2 | 0 | 11.516 |
| `fog_200` | `kiss_keyframe` | 3 | 0.000 | 0.000 | 0.000 | 3 | 3 | 0 | 3 | 0 | 0 | 0 | 3 | 0.000 |
...
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `fog_200` | `baseline` 0-29 | `nominal` | 30 | 0.006 | `geometry_icp` | 0.655 | n/a | 0.775 | 65.9 | 1.276 | 0.095 | `suspicious` | `suspicious` | `watch` | `false_alarm` | `false_alarm` | n/a | ok | ok | partial_acceptance |
...
| `fog_200` | `baseline` 0-29 | `nominal` | 30 | 0.006 | `kiss_keyframe` | 0.000 | 0.000 | 0.844 | 309.0 | 0.000 | 0.000 | `failed` | `failed` | `fail` | `false_alarm` | `false_alarm` | 0/2 | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence |
...
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | 30 | 0.521 | `geometry_icp` | 0.138 | n/a | 0.790 | 11.3 | 0.326 | 0.057 | `failed` | `failed` | `fail` | `stress_flagged` | `stress_flagged` | n/a | low_acceptance | low_acceptance | low_acceptance |
...
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | 30 | 0.521 | `kiss_keyframe` | 0.000 | 0.000 | 0.795 | 239.4 | 0.000 | 0.000 | `failed` | `failed` | `fail` | `stress_flagged` | `stress_flagged` | 0/2 | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence |
...
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `geometry_icp` | 0.000 | n/a | n/a | 0.0 | 0.000 | 0.000 | `failed` | `failed` | `fail` | `stress_flagged` | `stress_flagged` | n/a | all_pairs_failed, low_acceptance | all_pairs_failed, low_acceptance | all_pairs_failed, low_acceptance |
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `intensity_bev` | 1.000 | 1.000 | 0.801 | 5542.0 | 8.281 | 0.559 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | n/a | ok | cross_method_suspicious | cross_method_suspicious, no_healthy_peer, path_disagrees_with_all_method_median |
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `kiss_keyframe` | 0.000 | 0.000 | 0.794 | 163.3 | 0.000 | 0.000 | `failed` | `failed` | `fail` | `stress_flagged` | `stress_flagged` | 0/2 | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence | all_pairs_failed, low_acceptance, low_convergence |
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `ct_icp` | 0.655 | 0.000 | n/a | n/a | 2.655 | 0.229 | `suspicious` | `suspicious` | `watch` | `stress_flagged` | `stress_flagged` | n/a | low_convergence | low_convergence | low_convergence, partial_acceptance |
...
| `tunnel_geom_2700_200` | `baseline` 5-34 | `nominal` | 30 | 0.002 | `ct_icp` | 1.000 | 0.138 | n/a | n/a | 5.189 | 0.842 | `degraded` | `degraded` | `watch` | `false_alarm` | `false_alarm` | n/a | low_convergence | low_convergence | low_convergence |
...
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `point_count_stress` | 30 | 0.035 | `intensity_bev` | 1.000 | 1.000 | 0.540 | 5374.6 | 9.875 | 0.707 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | n/a | ok | cross_method_suspicious | cross_method_suspicious, path_disagrees_with_healthy_median |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `point_count_stress` | 30 | 0.035 | `kiss_keyframe` | 1.000 | 1.000 | 0.753 | 2643.2 | 0.988 | 0.102 | `ok` | `ok` | `watch` | `stress_unflagged` | `stress_unflagged` | 2/2 | ok | ok | path_disagrees_with_all_method_median |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `point_count_stress` | 30 | 0.035 | `ct_icp` | 1.000 | 0.103 | n/a | n/a | 5.412 | 0.433 | `degraded` | `degraded` | `watch` | `stress_flagged` | `stress_flagged` | n/a | low_convergence | low_convergence | low_convergence |
...
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `geometry_stress` | 30 | 0.045 | `intensity_bev` | 1.000 | 1.000 | 0.521 | 5114.1 | 12.642 | 0.707 | `ok` | `cross_method_suspicious` | `investigate` | `stress_unflagged` | `stress_flagged` | n/a | ok | cross_method_suspicious | cross_method_suspicious, path_disagrees_with_all_method_median, path_disagrees_with_healthy_median |
