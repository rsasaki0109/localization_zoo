...
| `fog_200` | `kiss_keyframe` | 3 | 1.000 | 1.000 | 1.000 | n/a | n/a | 0 | 0 | 0 | 0 | 0 | 3 | 0 | 0 | 0 | 0.743 |
| `fog_200` | `ct_icp` | 3 | 0.885 | 0.655 | 0.046 | 0.885 | 7.920 | 0 | 2 | 1 | 0 | 1 | 0 | 3 | 0 | 0 | 2.703 |
| `fog_200` | `litamin2` | 3 | 1.000 | 1.000 | 1.000 | n/a | n/a | 0 | 0 | 0 | 0 | 0 | 3 | 0 | 0 | 0 | 1.036 |
...
| `tunnel_geom_2700_200` | `litamin2` | 4 | 1.000 | 1.000 | 1.000 | n/a | n/a | 0 | 0 | 0 | 0 | 0 | 4 | 0 | 0 | 0 | 3.035 |
...
| `tunnel_geom_2700_200` | `litamin2` | 3 | 0 | 0 | 3 | 0 | 0 |
...
| `fog_200` | `point_count_tail` 115-144 | `litamin2` | 1.000 | n/a | n/a | n/a | n/a | needs_gt_or_cross_method_check |
...
| `fog_200` | `degraded` 170-199 | `litamin2` | 1.000 | n/a | n/a | n/a | n/a | needs_gt_or_cross_method_check |
...
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `litamin2` | 1.000 | n/a | n/a | n/a | n/a | needs_gt_or_cross_method_check |
...
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `litamin2` | 1.000 | n/a | n/a | n/a | n/a | needs_gt_or_cross_method_check |
...
| `tunnel_geom_2700_200` | `degraded` 170-199 | `litamin2` | 1.000 | n/a | n/a | n/a | n/a | needs_gt_or_cross_method_check |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `fog_200` | `point_count_tail` 115-144 | `geometry_icp` | 1.234 | 0.431 | 6.259 | 2 | 1.032 | 1.197 | 1.032 | 1.197 | no | none |
| `fog_200` | `point_count_tail` 115-144 | `kiss_keyframe` | 0.732 | 0.382 | 1.892 | 2 | 1.032 | 0.709 | 1.032 | 0.709 | no | none |
| `fog_200` | `point_count_tail` 115-144 | `litamin2` | 1.032 | 0.069 | 1.012 | 2 | 1.032 | 1.000 | 1.032 | 1.000 | no | none |
| `fog_200` | `degraded` 170-199 | `geometry_icp` | 1.407 | 0.681 | 2.851 | 2 | 0.867 | 1.624 | 1.407 | 1.000 | no | none |
| `fog_200` | `degraded` 170-199 | `kiss_keyframe` | 0.617 | 0.280 | 0.668 | 2 | 0.867 | 0.712 | 1.407 | 0.438 | no | none |
| `fog_200` | `degraded` 170-199 | `litamin2` | 0.867 | 0.127 | 3.099 | 2 | 0.867 | 1.000 | 1.407 | 0.616 | no | none |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `geometry_icp` | 1.867 | 0.123 | 2.392 | 2 | 1.602 | 1.166 | 1.602 | 1.166 | no | none |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `kiss_keyframe` | 1.072 | 0.398 | 0.072 | 2 | 1.602 | 0.669 | 1.602 | 0.669 | no | none |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `litamin2` | 1.602 | 0.292 | 0.504 | 2 | 1.602 | 1.000 | 1.602 | 1.000 | no | none |
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `geometry_icp` | 1.766 | 0.596 | 2.385 | 2 | 1.259 | 1.403 | 1.259 | 1.403 | no | none |
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `kiss_keyframe` | 1.259 | 0.098 | 0.664 | 2 | 1.259 | 1.000 | 1.259 | 1.000 | no | none |
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `litamin2` | 1.000 | 0.328 | 0.880 | 2 | 1.259 | 0.794 | 1.259 | 0.794 | no | none |
| `tunnel_geom_2700_200` | `degraded` 170-199 | `geometry_icp` | 1.178 | 0.311 | 1.798 | 2 | 1.582 | 0.744 | 1.582 | 0.744 | no | none |
| `tunnel_geom_2700_200` | `degraded` 170-199 | `kiss_keyframe` | 1.582 | 1.005 | 1.184 | 2 | 1.582 | 1.000 | 1.582 | 1.000 | no | none |
| `tunnel_geom_2700_200` | `degraded` 170-199 | `litamin2` | 3.049 | 2.728 | 2.039 | 2 | 1.582 | 1.927 | 1.582 | 1.927 | no | none |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `fog_200` | `baseline` 0-29 | `nominal` | `ct_icp` | 1.000 | 0.138 | 1.000 | 7.759 | 1.492 | 1.000 | no | `optimizer_retry` | iterations_pinned | ct_icp_internal_convergence_low |
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | `ct_icp` | 1.000 | 0.000 | 1.000 | 8.000 | 2.631 | 2.631 | no | `fallback_required` | iterations_pinned, path_vs_healthy_high | ct_icp_internal_convergence_low |
| `tunnel_geom_2700_200` | `baseline` 5-34 | `nominal` | `ct_icp` | 1.000 | 0.138 | 1.000 | 8.000 | 3.725 | 3.411 | no | `fallback_required` | iterations_pinned, path_vs_healthy_high, path_vs_all_high | ct_icp_internal_convergence_low |
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `point_count_stress` | `ct_icp` | 1.000 | 0.103 | 1.000 | 7.793 | 3.394 | 3.394 | no | `fallback_required` | iterations_pinned, path_vs_healthy_high, path_vs_all_high | ct_icp_internal_convergence_low |
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `geometry_stress` | `ct_icp` | 1.000 | 0.138 | 1.000 | 7.724 | 4.499 | 4.499 | no | `fallback_required` | iterations_pinned, path_vs_healthy_high, path_vs_all_high | ct_icp_internal_convergence_low |
| `tunnel_geom_2700_200` | `degraded` 170-199 | `degradation_stress` | `ct_icp` | 1.000 | 0.207 | 1.000 | 7.655 | 2.638 | 2.638 | no | `fallback_required` | iterations_pinned, path_vs_healthy_high | ct_icp_internal_convergence_low |
...
| `fog_200` | `baseline` 0-29 | `nominal` | 30 | 0.006 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 0.255 | 0.026 | `ok` | `ok` | `pass` | `nominal_ok` | `nominal_ok` | n/a | ok | ok | ok_no_risk |
...
| `fog_200` | `point_count_tail` 115-144 | `obscurant_stress` | 30 | 0.521 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 1.036 | 0.195 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | ok_no_risk |
...
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `kiss_keyframe` | 1.000 | 1.000 | n/a | n/a | 0.797 | 163.3 | 0.620 | 0.050 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | 0/2 | ok | ok | ok_no_risk |
...
| `fog_200` | `degraded` 170-199 | `obscurant_stress` | 30 | 0.911 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 0.863 | 0.061 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | ok_no_risk |
...
| `tunnel_geom_2700_200` | `baseline` 5-34 | `nominal` | 30 | 0.002 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 0.815 | 0.075 | `ok` | `ok` | `pass` | `nominal_ok` | `nominal_ok` | n/a | ok | ok | ok_no_risk |
...
| `tunnel_geom_2700_200` | `point_count_tail` 80-109 | `point_count_stress` | 30 | 0.035 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 1.595 | 0.144 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | ok_no_risk |
...
| `tunnel_geom_2700_200` | `geometry_degeneracy` 90-119 | `geometry_stress` | 30 | 0.045 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 1.000 | 0.123 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | ok_no_risk |
...
| `tunnel_geom_2700_200` | `degraded` 170-199 | `degradation_stress` | 30 | 0.227 | `litamin2` | 1.000 | 1.000 | n/a | n/a | n/a | n/a | 3.035 | 0.234 | `ok` | `ok` | `pass` | `stress_unflagged` | `stress_unflagged` | n/a | ok | ok | ok_no_risk |
...
- `fog_200` / `tunnel_geom_2700_200`: LiTAMIN2 window odometry now runs on the NTNU selected windows and currently stays accepted/converged on all selected short-window checks.
