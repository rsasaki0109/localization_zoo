...
| `watch` | 6 | `ct_icp`, `kiss_keyframe` | 0.943 | 0.241 | 2.402 | 1.242 |
| `investigate` | 6 | `intensity_bev`, `kiss_keyframe` | 0.989 | 0.989 | 5.994 | 3.146 |
...
| --- | --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `overlap_tail` | `investigate` | 1 | `intensity_bev` | `local_risk` | 0.931 | 0.931 | 11.516 | 11.714 | 11.714 | 5.832 | 5.832 |
| `motion_margin_dominant` | `investigate` | 2 | `intensity_bev` | `local_risk` | 0.966 | 0.966 | 9.538 | 8.596 | 11.714 | 4.230 | 5.832 |
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `fog_200` | `point_count_tail` 115-144 | `intensity_bev` | `investigate` | `local_risk` | 0.931 | 0.931 | 11.714 | 5.832 | `motion_margin_dominant`, `overlap_tail` |
