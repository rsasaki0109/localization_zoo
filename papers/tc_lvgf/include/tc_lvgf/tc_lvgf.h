...
class TcLvgfPipeline {
 public:
  explicit TcLvgfPipeline(const TcLvgfParams& params = TcLvgfParams());
  ...
  TcLvgfResult registerFrame(const std::vector<Eigen::Vector3d>& frame);
